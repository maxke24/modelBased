"""
This script filters CSV files based on whether specific nodes appear in a Wikipedia table of Belgian railway stations.

Key Features:
- **Wikipedia Validation:** Checks if nodes from CSV files exist in a predefined Wikipedia table.
- **CSV Filtering:** Reads CSV files, filters rows with valid nodes, and saves the filtered data into a new directory.

Functions:
- **is_in_wikipedia_table:** Determines if a node is listed in the Wikipedia table.
